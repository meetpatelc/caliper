        ...
        <div className="flex h-14 items-center gap-2 px-3 sm:gap-3 sm:px-5">
          ...
          <button
            ...
            className={cn(
              ...
              "min-h-10 min-w-0 flex-1 justify-start gap-2 bg-surface font-normal text-muted hover:border-accent hover:text-fg md:max-w-xl",
            )}
          >
            <Search size={15} className="shrink-0" />
            <span className="hidden min-[420px]:block flex-1 truncate text-left">Search models…</span>
            <span className="min-[420px]:hidden flex-1 truncate text-left">Search</span>
          ...
          <button
            ref={menuTriggerRef}
            type="button"
            className={cn(buttonVariants({ variant: "outline", size: "icon" }), "shrink-0 md:hidden")}
