...
export const mathematicsDocuments: Record<string, InstrumentDocument> = {
  circularArc: libraryDoc("circularArc", {
    ...
    outputs: [
      { id: "arc", label: "Arc length", family: "length", defaultUnit: "mm", expression: "(radius*angle*pi/180)*0.001" },
      { id: "chord", label: "Chord length", family: "length", defaultUnit: "mm", expression: "(2*radius*sin(angle*pi/360))*0.001" },
      { id: "sector", label: "Sector area", family: "area", defaultUnit: "mm²", expression: "(radius^2*(angle*pi/180)/2)*1e-06" },
      { id: "segment", label: "Circular-segment area", family: "area", defaultUnit: "mm²", expression: "(radius^2*(angle*pi/180)/2-radius^2*sin(angle*pi/180)/2)*1e-06" },
    ],
  ...
  pitchCircle: libraryDoc("pitchCircle", {
    ...
    outputs: [
      { id: "radius", label: "Pitch-circle radius", family: "length", defaultUnit: "mm", expression: "(((pcd)/2))*0.001" },
      { id: "angularPitch", label: "Equal angular pitch", family: "angle", defaultUnit: "°", expression: "((360/(holeCount)))*0.017453292519943295" },
      { id: "adjacentChord", label: "Adjacent-center chord", family: "length", defaultUnit: "mm", expression: "((2*((pcd)/2)*sin(pi/(holeCount))))*0.001" },
      { id: "firstX", label: "First-hole nominal X", family: "length", defaultUnit: "mm", expression: "((((pcd)/2)*cos((startAngle)*pi/180)))*0.001" },
      { id: "firstY", label: "First-hole nominal Y", family: "length", defaultUnit: "mm", expression: "(((pcd)/2)*sin((startAngle)*pi/180))" },
      { id: "oppositeX", label: "180° opposite nominal X", family: "length", defaultUnit: "mm", expression: "((((pcd)/2)*cos(((startAngle)+180)*pi/180)))*0.001" },
      { id: "oppositeY", label: "180° opposite nominal Y", family: "length", defaultUnit: "mm", expression: "(((pcd)/2)*sin(((startAngle)+180)*pi/180))" },
    ],
  ...
  regularPolygon: libraryDoc("regularPolygon", {
    ...
    outputs: [
      { id: "perimeter", label: "Perimeter", family: "length", defaultUnit: "mm", expression: "(((sideCount)*(sideLength)))*0.001" },
      { id: "apothem", label: "Apothem", family: "length", defaultUnit: "mm", expression: "(((sideLength)/(2*tan((pi/(sideCount))))))*0.001" },
      { id: "circumradius", label: "Circumradius", family: "length", defaultUnit: "mm", expression: "(((sideLength)/(2*sin((pi/(sideCount))))))*0.001" },
      { id: "interiorAngle", label: "Each interior angle", family: "angle", defaultUnit: "°", expression: "((((sideCount)-2)*180/(sideCount)))*0.017453292519943295" },
      { id: "area", label: "Regular-polygon area", family: "area", defaultUnit: "mm²", expression: "((0.5*((sideLength)/(2*tan((pi/(sideCount)))))*((sideCount)*(sideLength))))*1e-06" },
    ],
  ...
  triangle: libraryDoc("triangle", {
    ...
    outputs: [
      { id: "hypotenuse", label: "Hypotenuse", family: "length", defaultUnit: "mm", expression: "(hypot(legA, legB))*0.001" },
      { id: "area", label: "Triangle area", family: "area", defaultUnit: "mm²", expression: "(legA*legB/2)*1e-06" },
      { id: "alpha", label: "Angle from horizontal", family: "angle", defaultUnit: "°", expression: "(atan2(legB, legA)*180/pi)*0.017453292519943295" },
      { id: "beta", label: "Other acute angle", family: "angle", defaultUnit: "°", expression: "(90-atan2(legB, legA)*180/pi)*0.017453292519943295" },
    ],
