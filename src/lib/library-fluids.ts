...
export const fluidsDocuments: Record<string, InstrumentDocument> = {
  ...
  buoyancyForce: libraryDoc("buoyancyForce", {
    ...
    outputs: [
      { id: "buoyancy", label: "Constant-density buoyant force", family: "force", defaultUnit: "N", expression: "fluidDensity*9.80665*(displacedVolume/1000)" },
      { id: "weight", label: "Declared object gravitational weight", family: "force", defaultUnit: "N", expression: "objectMass*9.80665" },
      { id: "netUpwardForce", label: "Buoyancy minus declared weight", family: "force", defaultUnit: "N", expression: "fluidDensity*9.80665*(displacedVolume/1000)-objectMass*9.80665" },
      { id: "displacedMass", label: "Mass of declared displaced fluid", family: "mass", defaultUnit: "kg", expression: "fluidDensity*(displacedVolume/1000)" },
    ],
  ...
  compressibleMassFlow: libraryDoc("compressibleMassFlow", {
    ...
    outputs: [
      { id: "massFlow", label: "Literal ideal compressible mass flow", family: "massFlow", defaultUnit: "kg/s", expression: "(((flowArea)*(totalPressure)/sqrt((totalTemperature)))*sqrt((specificHeatRatio)/(gasConstant))*(machNumber)*(1+(((specificHeatRatio)-1)/2)*((machNumber))^(2))^(-((specificHeatRatio)+1)/(2*((specificHeatRatio)-1))))" },
      ...
      { id: "totalPressure", label: "Declared total pressure", family: "pressure", defaultUnit: "Pa", expression: "(totalPressure)" },
    ],
  ...
  hydraulicAccumulatorState: libraryDoc("hydraulicAccumulatorState", {
    ...
    outputs: [
      { id: "gasVolumeAtMaximum", label: "Literal gas volume at declared maximum pressure", family: "volume", defaultUnit: "L", expression: "(((prechargeGasVolume)*((prechargePressure)/((maximumWorkingPressure)))^((1/(polytropicExponent)))))*0.001" },
      { id: "gasVolumeAtMinimum", label: "Literal gas volume at declared minimum pressure", family: "volume", defaultUnit: "L", expression: "(((prechargeGasVolume)*((prechargePressure)/((minimumWorkingPressure)))^((1/(polytropicExponent)))))*0.001" },
      { id: "usableFluidVolume", label: "Literal usable fluid-volume difference", family: "volume", defaultUnit: "L", expression: "((((prechargeGasVolume)*((prechargePressure)/((minimumWorkingPressure)))^((1/(polytropicExponent))))-((prechargeGasVolume)*((prechargePressure)/((maximumWorkingPressure)))^((1/(polytropicExponent))))))*0.001" },
  ...
  hydraulicCylinder: libraryDoc("hydraulicCylinder", {
    ...
    outputs: [
      ...
      { id: "extendVolume", label: "Extension swept volume", family: "volume", defaultUnit: "L", expression: "(((pi*((bore))^(2)/4)*(stroke)/1e6))*0.001" },
      { id: "retractVolume", label: "Retraction swept volume", family: "volume", defaultUnit: "L", expression: "((((pi*((bore))^(2)/4)-pi*((rod))^(2)/4)*(stroke)/1e6))*0.001" },
      { id: "extendSpeed", label: "Ideal extension speed", family: "speed", defaultUnit: "mm/s", expression: "(((flow)*1e6/60/(pi*((bore))^(2)/4)))*0.001" },
      { id: "retractSpeed", label: "Ideal retraction speed", family: "speed", defaultUnit: "mm/s", expression: "(((flow)*1e6/60/((pi*((bore))^(2)/4)-pi*((rod))^(2)/4)))*0.001" },
      { id: "extendTime", label: "Ideal extension travel time", family: "time", defaultUnit: "s", expression: "((stroke)/((flow)*1e6/60/(pi*((bore))^(2)/4)))" },
      { id: "retractTime", label: "Ideal retraction travel time", family: "time", defaultUnit: "s", expression: "((stroke)/((flow)*1e6/60/((pi*((bore))^(2)/4)-pi*((rod))^(2)/4)))" },
    ],
  ...
  hydraulicLine: libraryDoc("hydraulicLine", {
    ...
    outputs: [
      ...
      { id: "velocity", label: "Mean line velocity", family: "speed", defaultUnit: "m/s", expression: "((flow)/60000/(pi*((insideDiameter)/(1000))^(2)/4))" },
  ...
  hydraulicLossBudget: libraryDoc("hydraulicLossBudget", {
    ...
    outputs: [
      { id: "lossPower", label: "Literal hydraulic pressure-drop power", family: "power", defaultUnit: "kW", expression: "(((pressureDrop)*(flow)/600))*1000" },
      { id: "averageLossPower", label: "Literal active-time-scaled loss power", family: "power", defaultUnit: "kW", expression: "((((pressureDrop)*(flow)/600)*(activeTimeFraction)/100))*1000" },
      ...
      { id: "activeTimeFraction", label: "Declared active-time fraction", family: "dimensionless", defaultUnit: "%", expression: "((activeTimeFraction))*0.01" },
    ],
  ...
  hydraulicMotor: libraryDoc("hydraulicMotor", {
    ...
    outputs: [
      { id: "theoreticalTorque", label: "Theoretical shaft torque", family: "torque", defaultUnit: "N·m", expression: "((pressure)*1e5*(displacement)*1e-6/(2*pi))" },
      { id: "actualTorque", label: "Declared-efficiency shaft torque", family: "torque", defaultUnit: "N·m", expression: "(((pressure)*1e5*(displacement)*1e-6/(2*pi))*(mechanicalEfficiency)/100)" },
      ...
      { id: "hydraulicPower", label: "Hydraulic input power", family: "power", defaultUnit: "kW", expression: "(((pressure)*(flow)/600))*1000" },
      { id: "shaftPower", label: "Declared-efficiency shaft output", family: "power", defaultUnit: "kW", expression: "(((((pressure)*1e5*(displacement)*1e-6/(2*pi))*(mechanicalEfficiency)/100)*(((flow)*1000/(displacement))*(volumetricEfficiency)/100)*2*pi/60/1000))*1000" },
    ],
  ...
  hydraulicPump: libraryDoc("hydraulicPump", {
    ...
    outputs: [
      { id: "idealFlow", label: "Ideal outlet flow", family: "volumetricFlow", defaultUnit: "L/min", expression: "(((displacement)*(speed)/1000))*1.6666666666666667e-05" },
      { id: "actualFlow", label: "Declared-efficiency outlet flow", family: "volumetricFlow", defaultUnit: "L/min", expression: "((((displacement)*(speed)/1000)*(volumetricEfficiency)/100))*1.6666666666666667e-05" },
      { id: "hydraulicPower", label: "Hydraulic output power", family: "power", defaultUnit: "kW", expression: "(((pressure)*(((displacement)*(speed)/1000)*(volumetricEfficiency)/100)/600))*1000" },
      { id: "shaftPower", label: "Declared-efficiency shaft input power", family: "power", defaultUnit: "kW", expression: "((((pressure)*(((displacement)*(speed)/1000)*(volumetricEfficiency)/100)/600)/((overallEfficiency)/100)))*1000" },
      { id: "theoreticalTorque", label: "Theoretical pressure-displacement input torque", family: "torque", defaultUnit: "N·m", expression: "((pressure)*1e5*(displacement)*1e-6/(2*pi))" },
    ],
  ...
  minorLosses: libraryDoc("minorLosses", {
    ...
    outputs: [
      { id: "dynamicPressure", label: "Declared-section dynamic pressure", family: "pressure", defaultUnit: "Pa", expression: "((density)*((velocity))^(2)/2)" },
      { id: "pressureLoss", label: "Declared-coefficient minor pressure loss", family: "pressure", defaultUnit: "Pa", expression: "((sumK)*((density)*((velocity))^(2)/2))" },
      { id: "headLoss", label: "Equivalent liquid head loss", family: "length", defaultUnit: "m", expression: "(((sumK)*(((density))*((velocity))^(2)/2))/((density)*9.80665))" },
    ],
  ...
  orificeFlow: libraryDoc("orificeFlow", {
    ...
    outputs: [
      ...
      { id: "massFlow", label: "Mass flow", family: "massFlow", defaultUnit: "kg/s", expression: "(((dischargeCoefficient)*(pi*((orificeDiameter)/(1000))^(2)/4)*sqrt(2*((upstreamPressure)-(downstreamPressure))/(((density))*(1-(((orificeDiameter)/(pipeDiameter)))^(4)))))*(density))" },
      { id: "throatVelocity", label: "Orifice mean velocity", family: "speed", defaultUnit: "m/s", expression: "(((dischargeCoefficient)*(pi*((orificeDiameter)/(1000))^(2)/4)*sqrt(2*((upstreamPressure)-(downstreamPressure))/((density)*(1-(((orificeDiameter)/(pipeDiameter)))^(4)))))/(pi*((orificeDiameter)/(1000))^(2)/4))" },
      { id: "pressureDrop", label: "Stated pressure difference", family: "pressure", defaultUnit: "Pa", expression: "((upstreamPressure)-(downstreamPressure))" },
  ...
  pneumaticLineLoss: libraryDoc("pneumaticLineLoss", {
    ...
    outputs: [
      ...
      { id: "velocity", label: "Mean upstream-density air velocity", family: "speed", defaultUnit: "m/s", expression: "((actualFlow)/60/(pi*(((insideDiameter)/1000))^(2)/4))" },
  ...
  pumpSystemHeadPoint: libraryDoc("pumpSystemHeadPoint", {
    ...
    outputs: [
      { id: "systemHead", label: "Literal declared system head at flow point", family: "length", defaultUnit: "m", expression: "((staticHead)+((quadraticLossCoefficient)*((flowPoint))^(2)))" },
      { id: "staticHead", label: "Declared static-head offset", family: "length", defaultUnit: "m", expression: "(staticHead)" },
      { id: "quadraticLossHead", label: "Literal declared quadratic loss head", family: "length", defaultUnit: "m", expression: "((quadraticLossCoefficient)*((flowPoint))^(2))" },
      { id: "flowPoint", label: "Declared flow point", family: "volumetricFlow", defaultUnit: "L/s", expression: "((flowPoint))*0.001" },
    ],
  ...
  reynoldsNumber: libraryDoc("reynoldsNumber", {
    ...
    outputs: [
      ...
      { id: "kinematicViscosity", label: "Declared-condition kinematic viscosity", family: "kinematicViscosity", defaultUnit: "m²/s", expression: "dynamicViscosity/density" },
  ...
  submergedPlane: libraryDoc("submergedPlane", {
    ...
    outputs: [
      { id: "area", label: "Rectangle area", family: "area", defaultUnit: "m²", expression: "((width)*(height))" },
      ...
      { id: "centroidalInertia", label: "Rectangle centroidal second moment", family: "secondMoment", defaultUnit: "m⁴", expression: "((width)*((height))^(3)/12)" },
      { id: "centerOffset", label: "Center-of-pressure offset below centroid", family: "length", defaultUnit: "m", expression: "(((width)*((height))^(3)/12)/(((width)*(height))*(centroidDepth)))" },
      { id: "centerDepth", label: "Center-of-pressure depth below free surface", family: "length", defaultUnit: "m", expression: "((centroidDepth)+(((width)*((height))^(3)/12)/(((width)*(height))*(centroidDepth))))" },
    ],
  ...
  vacuumEvacuation: libraryDoc("vacuumEvacuation", {
    ...
    outputs: [
      ...
      { id: "idealTime", label: "Ideal constant-speed evacuation time", family: "time", defaultUnit: "s", expression: "((vesselVolume)/(effectiveSpeed)*(ln(((startPressure)/(targetPressure)))))" },
      { id: "requiredEffectiveSpeed", label: "Effective speed for declared time target", family: "volumetricFlow", defaultUnit: "L/s", expression: "(((vesselVolume)/(targetTime)*(ln(((startPressure)/(targetPressure))))))*0.001" },
