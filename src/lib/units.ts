...
export const unitFamilies = {
  length: { id: "length", label: "Length", canonicalUnit: "m", domain: "foundation", units: { m: linear("m", "metre", 1), mm: linear("mm", "millimetre", 1e-3), cm: linear("cm", "centimetre", 1e-2), km: linear("km", "kilometre", 1e3), in: linear("in", "inch", 0.0254), ft: linear("ft", "foot", 0.3048), yd: linear("yd", "yard", 0.9144) } },
  ...
  pressure: { id: "pressure", label: "Pressure", canonicalUnit: "Pa", domain: "mechanics", units: { Pa: linear("Pa", "pascal", 1), kPa: linear("kPa", "kilopascal", 1e3), MPa: linear("MPa", "megapascal", 1e6), bar: linear("bar", "bar", 1e5), psi: linear("psi", "pounds per square inch", 6894.757293168), atm: linear("atm", "standard atmosphere", 101325) } },
  stress: { id: "stress", label: "Stress", canonicalUnit: "Pa", domain: "mechanics", units: { Pa: linear("Pa", "pascal", 1), kPa: linear("kPa", "kilopascal", 1e3), MPa: linear("MPa", "megapascal", 1e6), GPa: linear("GPa", "gigapascal", 1e9), psi: linear("psi", "pounds per square inch", 6894.757293168), ksi: linear("ksi", "thousand pounds per square inch", 6894757.293168) } },
  ...
  speed: { id: "speed", label: "Speed", canonicalUnit: "m/s", domain: "mechanics", units: { "m/s": linear("m/s", "metres per second", 1), "km/h": linear("km/h", "kilometres per hour", 1 / 3.6), mph: linear("mph", "miles per hour", 0.44704), "ft/s": linear("ft/s", "feet per second", 0.3048) } },
  ...
  volumetricFlow: { id: "volumetricFlow", label: "Volumetric flow", canonicalUnit: "m³/s", domain: "fluids", units: { "m³/s": linear("m³/s", "cubic metres per second", 1), "L/s": linear("L/s", "litres per second", 1e-3), "L/min": linear("L/min", "litres per minute", 1 / 60000), "gal/min": linear("gal/min", "US gallons per minute", 6.30901964e-5), cfm: linear("cfm", "cubic feet per minute", 4.719474432e-4) } },
